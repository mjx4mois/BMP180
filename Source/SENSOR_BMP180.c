...
---------------------------------------------------------------------- */
#ifndef __BMP180_FUNCTION__
#define __BMP180_FUNCTION__
...
void BMP180_GET_CAL_COEFF(void)
{
       ...
       CHAR8S fail_flag=0;
        ...
        BMP180_CAL_COFF.AC1 = (INT16S) ( (BMP_CAL_COFF_ARRAY[0]<<8) + BMP_CAL_COFF_ARRAY[1]);
        BMP180_CAL_COFF.AC2 = (INT16S) ( (BMP_CAL_COFF_ARRAY[2]<<8) + BMP_CAL_COFF_ARRAY[3]);
        BMP180_CAL_COFF.AC3 = (INT16S) ( (BMP_CAL_COFF_ARRAY[4]<<8) + BMP_CAL_COFF_ARRAY[5]);
        BMP180_CAL_COFF.AC4 = (INT16S) ( (BMP_CAL_COFF_ARRAY[6]<<8) + BMP_CAL_COFF_ARRAY[7]);
        BMP180_CAL_COFF.AC5 = (INT16S) ( (BMP_CAL_COFF_ARRAY[8]<<8) + BMP_CAL_COFF_ARRAY[9]);
        BMP180_CAL_COFF.AC6 = (INT16S) ( (BMP_CAL_COFF_ARRAY[10]<<8) + BMP_CAL_COFF_ARRAY[11]);
        BMP180_CAL_COFF.B1 =  (INT16S) ( (BMP_CAL_COFF_ARRAY[12]<<8) + BMP_CAL_COFF_ARRAY[13]);
        BMP180_CAL_COFF.B2 =  (INT16S) ( (BMP_CAL_COFF_ARRAY[14]<<8) + BMP_CAL_COFF_ARRAY[15]);
        BMP180_CAL_COFF.MB =  (INT16S) ( (BMP_CAL_COFF_ARRAY[16]<<8) + BMP_CAL_COFF_ARRAY[17]);
        BMP180_CAL_COFF.MC =  (INT16S) ( (BMP_CAL_COFF_ARRAY[18]<<8) + BMP_CAL_COFF_ARRAY[19]);
        BMP180_CAL_COFF.MD =  (INT16S) ( (BMP_CAL_COFF_ARRAY[20]<<8) + BMP_CAL_COFF_ARRAY[21]);
         ...
         printf("AC1 = 0x%X(%d)\r\n", BMP180_CAL_COFF.AC1,BMP180_CAL_COFF.AC1);
         printf("AC2 = 0x%X(%d)\r\n", BMP180_CAL_COFF.AC2,BMP180_CAL_COFF.AC2);
         printf("AC3 = 0x%X(%d)\r\n", BMP180_CAL_COFF.AC3,BMP180_CAL_COFF.AC3);
         printf("AC4 = 0x%X(%d)\r\n", BMP180_CAL_COFF.AC4,BMP180_CAL_COFF.AC4);
         printf("AC5 = 0x%X(%d)\r\n", BMP180_CAL_COFF.AC5,BMP180_CAL_COFF.AC5);
         printf("AC6 = 0x%X(%d)\r\n", BMP180_CAL_COFF.AC6,BMP180_CAL_COFF.AC6);
         printf("B1 = 0x%X(%d)\r\n", BMP180_CAL_COFF.B1,BMP180_CAL_COFF.B1);
         printf("B2 = 0x%X(%d)\r\n", BMP180_CAL_COFF.B2,BMP180_CAL_COFF.B2);
         printf("MB = 0x%X(%d)\r\n", BMP180_CAL_COFF.MB,BMP180_CAL_COFF.MB);
         printf("MC = 0x%X(%d)\r\n", BMP180_CAL_COFF.MC,BMP180_CAL_COFF.MC);
         printf("MD = 0x%X(%d)\r\n", BMP180_CAL_COFF.MD,BMP180_CAL_COFF.MD);
...
CHAR8S BMP180_GET_TEMP_PRESS(INT32S *temperature_data,FLOAT *pressure_data,CHAR8U oss)
{
	...
	X1 = ((INT32S)Temp_value - BMP180_CAL_COFF.AC6)*(BMP180_CAL_COFF.AC5)/32768;
	X2 =  (INT32S)((INT32S)BMP180_CAL_COFF.MC *2048)/(INT32S)(X1 + (INT32S)BMP180_CAL_COFF.MD);
	B5 = (INT32S)(X1 + X2);
	REAL_TEMPUTRE = (INT32S)(B5 + 8)/ 16;        /* Final Temperature , ex: 153 temp  setp in 0.1 , 15.3 oC */
     ...
     /* Calculation Pressuree */
        ...
        X1 = ((BMP180_CAL_COFF.B2)*pr1)/2048 ;
        X2 = (INT32S) ((INT32S)BMP180_CAL_COFF.AC2) * B6 / 2048;
        X3 = X1 + X2;
        B3 =(INT32S)(((((INT32S)BMP180_CAL_COFF.AC1*4+X3)<< (INT32S)(oss) ) + 2)/4 );
        X1 =(INT32S)(((INT32S)BMP180_CAL_COFF.AC3 * B6)/8192);
        X2 =(INT32S)(((INT32S)BMP180_CAL_COFF.B1 * ((B6*B6)/4096))/65536);
        X3 =(INT32S)(((X1 + X2) + 2)/4);
        pr4 =(INT32S)(X3 + 32768);
        pr5 =(INT32S)BMP180_CAL_COFF.AC4;
...
#endif		//#ifndef __BMP180_FUNCTION__
